...
export class RollWithOriginalExpression extends Roll {
    ...
    static createRoll(parts, expressionPartsReplacements, data = {}, options = {}) {
        ...
        if (game.settings.get("dnd4eAltus", "showRollExpression")) {
     ...
     */
    static CHAT_TEMPLATE = "systems/dnd4eAltus/templates/chat/roll-template-single.html";
   ...
   getChatData(isPrivate = false) {
       if (!isPrivate && game.settings.get("dnd4eAltus", "showRollExpression")) {
